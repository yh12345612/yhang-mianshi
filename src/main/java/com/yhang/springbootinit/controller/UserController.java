...
import com.yhang.springbootinit.model.dto.user.*;
...
import static com.yhang.springbootinit.service.impl.UserServiceImpl.SALT;
...
public class UserController {
    ...
    public BaseResponse<LoginUserVO> userLogin(@RequestBody UserLoginRequest userLoginRequest, HttpServletRequest request) {
        ...
        if (loginUserVO!=null&& UserRoleEnum.BAN.getValue().equals(loginUserVO.getUserRole()))
        {
            return ResultUtils.error(ErrorCode.NO_AUTH_ERROR,"用户被封禁");
        }
    ...
    public BaseResponse<List<Integer>> getUserSignIn(HttpServletRequest request) {
        User loginUser = userService.getLoginUser(request);

        List<Integer> userSignRecord = userService.getUserSignRecord(loginUser.getId(), LocalDateTime.now().getYear());
