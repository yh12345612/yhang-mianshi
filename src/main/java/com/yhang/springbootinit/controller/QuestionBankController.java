...
import com.yhang.springbootinit.model.dto.questionBank.QuestionBankAddRequest;
import com.yhang.springbootinit.model.dto.questionBank.QuestionBankEditRequest;
import com.yhang.springbootinit.model.dto.questionBank.QuestionBankQueryRequest;
import com.yhang.springbootinit.model.dto.questionBank.QuestionBankUpdateRequest;
...
public class QuestionBankController {
    ...
    public BaseResponse<QuestionBankVO> getQuestionBankVOById(QuestionBankQueryRequest questionBankQueryRequest, HttpServletRequest request) {
        ThrowUtils.throwIf(questionBankQueryRequest == null, ErrorCode.NOT_FOUND_ERROR);
        // 查询数据库
        System.out.println(questionBankQueryRequest);
        ...
        // 获取封装类
        if(questionBankQueryRequest.isNeedQuestionListQuery())
        {
     ...
     * 限流：提示“系统压力过大，请耐心等待”
     * handleBlockException同时处理熔断后的降级和限流操作，要把熔断后的降级操作交给降级操作区执行
     */
    ...
    @SentinelResource(value = "listQuestionBankVOByPage",blockHandler = "handleBlockException",fallback = "handleFallBack")//定义资源
